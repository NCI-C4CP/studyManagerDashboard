...
export const getImportantRows = (participant, changedOption) => {
    ...
    const importantRowsArray = [ 
        ...
        { field: fieldMapping.physicalAddress1,
            label: 'Physical Address Line 1 (Only for participants with PO Box)',
            editable: !isParticipantDataDestroyed,
            display: true,
            validationType: 'address',
            isRequired: true
        ...
        { field: fieldMapping.physicalAddress2,
            label: 'Physical Address Line 2 (Only for participants with PO Box)',
            editable: !isParticipantDataDestroyed,
            display: true,
            validationType: 'address',
            isRequired: false
        ...
        { field: fieldMapping.physicalCity,
            label: 'Physical City (Only for participants with PO Box)',
            editable: !isParticipantDataDestroyed,
            display: true,
            validationType: 'text',
            isRequired: true
        ...
        { field: fieldMapping.physicalState,
            label: 'Physical State (Only for participants with PO Box)',
            editable: !isParticipantDataDestroyed,
            display: true,
            validationType: 'state',
            isRequired: true
        ...
        { field: fieldMapping.physicalZip,
            label: 'Physical Zip (Only for participants with PO Box)',
            editable: !isParticipantDataDestroyed,
            display: true,
            validationType: 'zip',
            isRequired: true
